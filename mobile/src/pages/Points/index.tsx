...
import { Text, View, ScrollView, StyleSheet, Image, SafeAreaView, Alert } from 'react-native';
...
const Points = () => {
  ...
  useEffect(() => {
    async function loadPosition() {
      ...
      if (status !== 'granted') {
        Alert.alert('Vish maria....', 'Precisamos da sua permissão para algumas funcionalidades do app :/');
        return;
      }
  ...
  function handleSelectItem(id: number) {
    const alreadyExist = selectedItems.findIndex(item => item === id);
